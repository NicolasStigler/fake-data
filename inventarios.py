...
for i in range(180): #inventarios a crear
    tenant_id = "plazavea"
...
for i in range(300): # inventarios a crear
    tenant_id = "plazavea"
...
for i in range(170): #inventarios a crear
    tenant_id = "wong"
...
for i in range(200): #inventarios a crear
    tenant_id = "wong"
    inventory_name = f"{fake.state()}-{fake.city()}"
...
for i in range(400): #inventarios a crear
    tenant_id = "uwu"
